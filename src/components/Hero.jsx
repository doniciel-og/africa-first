...
export default function Hero() {
  return (
    <section className="min-h-screen bg-gradient-to-br from-black via-green-950 to-black text-white pt-28">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-14 items-center min-h-[85vh]">
        ...
        <div className="flex justify-center">
          ...
          <img
            src={heroBanner}
            alt="Africa First"
            className="rounded-3xl shadow-2xl border border-green-500/20"
          />
